# =============================================================================
# FILE: Scr/agents/gru_agent.py (VERSION 7.0 - WORKING)
# =============================================================================
...
class GRUAgent(BaseAgent):
    ...
    def __init__(self, env, config=None, name="GRU_Agent", seed=42, device="cpu", track_user=True):
        ...
        print(f"   GRU State dim: {self.state_dim}, Action dim: {self.action_dim}")
        print(f"   Hidden dim: {self.hidden_dim}, Batch size: {self.batch_size}")
        
        self.policy = SimpleGRUNet(self.state_dim, self.action_dim, self.hidden_dim).to(self.device)
        ...
        logger.info(f"✅ GRU Agent initialized")
    ...
    def collect_trajectory(self, max_steps=500):
        self.memory = []
    ...
    def update(self):
        ...
        for _ in range(self.epochs):
            ...
            for start in range(0, n, self.batch_size):
                ...
                b_states = states[b_idx].unsqueeze(1)
    ...
    def train(self, total_timesteps=150000, callback=None):
        print(f"🚀 Starting GRU training for {total_timesteps} steps")
